...
const Registration = () => {
  ...
  // const checkFields = () =>{
  //   if(document.getElementById('formBasicPassword') === document.getElementById('formRepeatedPassword')){
  //     console.log("right")
  //     user.setIsAuth(true)
  //   }
  //   else{
  ...
  return (
      <div class="Registr">
        ...
        <Form style={{position: 'absolute', width: 420, top: 260, left: 120}}>
          ...
          <Button className="mt-3 align-self-end" variant="primary" type="submit">
            Submit
          </Button>
